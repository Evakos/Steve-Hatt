  ...
  return (
    <>
      ...
      {pendingCapture.length === 0 ? (
        <p className="mt-10 text-center text-base text-text-light">No orders awaiting capture right now.</p>
      ) : (
      ...
      {processing.length === 0 ? (
        <p className="mt-10 text-center text-base text-text-light">No orders being prepared right now.</p>
      ) : (
        <div className="mt-6 space-y-3">
